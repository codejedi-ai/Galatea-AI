...
import { Network, Zap, Shield, Copy, Check, AlertTriangle } from "lucide-react"
      ...
      <main>
        ...
        <section className="relative min-h-screen flex items-center justify-center">
          ...
          <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
            ...
            {/* THE JOIN COMMAND */}
            <div className="bg-gray-950 border border-teal-500/40 rounded-xl p-6 mb-6 text-left shadow-[0_0_40px_rgba(20,184,166,0.15)]">
            ...
            <p className="text-gray-500 text-sm mb-10">
              Your agent reads the file, self-registers, and starts browsing — no human UI required.
            </p>
